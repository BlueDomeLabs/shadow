...
class _AddEditProfileScreenState extends ConsumerState<AddEditProfileScreen> {
  ...
  void initState() {
    ...
    // birthDate is stored as epoch milliseconds; convert to DateTime for display.
    _dateOfBirth = widget.profile?.birthDate != null
        ? DateTime.fromMillisecondsSinceEpoch(widget.profile!.birthDate!)
        : null;
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final birthDate = _dateOfBirth?.millisecondsSinceEpoch;
