...
mixin _$UpdateConditionInput {
  ...
  /// Create a copy of UpdateConditionInput
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateConditionInputCopyWith<UpdateConditionInput> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateConditionInputCopyWith<$Res> {
  factory $UpdateConditionInputCopyWith(
    UpdateConditionInput value,
    $Res Function(UpdateConditionInput) then,
  ) = _$UpdateConditionInputCopyWithImpl<$Res, UpdateConditionInput>;
  @useResult
  $Res call({
    String id,
    String profileId,
...
/// @nodoc
class _$UpdateConditionInputCopyWithImpl<
  $Res,
  $Val extends UpdateConditionInput
>
    implements $UpdateConditionInputCopyWith<$Res> {
  _$UpdateConditionInputCopyWithImpl(this._value, this._then);
    ...
    return _then(
      _value.copyWith(
            ...
            category: freezed == category
                ...
                : category // ignore: cast_nullable_to_non_nullable
                      as String?,
            bodyLocations: freezed == bodyLocations
                ? _value.bodyLocations
                : bodyLocations // ignore: cast_nullable_to_non_nullable
                      as List<String>?,
            description: freezed == description
...
/// @nodoc
abstract class _$$UpdateConditionInputImplCopyWith<$Res>
    implements $UpdateConditionInputCopyWith<$Res> {
  factory _$$UpdateConditionInputImplCopyWith(
    _$UpdateConditionInputImpl value,
    $Res Function(_$UpdateConditionInputImpl) then,
  ) = __$$UpdateConditionInputImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$$UpdateConditionInputImplCopyWithImpl<$Res>
    extends _$UpdateConditionInputCopyWithImpl<$Res, _$UpdateConditionInputImpl>
    implements _$$UpdateConditionInputImplCopyWith<$Res> {
  __$$UpdateConditionInputImplCopyWithImpl(
    _$UpdateConditionInputImpl _value,
    $Res Function(_$UpdateConditionInputImpl) _then,
  ) : super(_value, _then);
...
class _$UpdateConditionInputImpl implements _UpdateConditionInput {
  const _$UpdateConditionInputImpl({
    required this.id,
    required this.profileId,
    this.name,
    this.category,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateConditionInputImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.profileId, profileId) ||
                other.profileId == profileId) &&
            (identical(other.name, name) || other.name == name) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateConditionInputImplCopyWith<_$UpdateConditionInputImpl>
  get copyWith =>
      __$$UpdateConditionInputImplCopyWithImpl<_$UpdateConditionInputImpl>(
        this,
        _$identity,
      );
}

abstract class _UpdateConditionInput implements UpdateConditionInput {
  const factory _UpdateConditionInput({
    required final String id,
    required final String profileId,
    final String? name,
    final String? category,
