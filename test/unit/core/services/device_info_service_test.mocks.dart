...
// in shadow_app/test/unit/core/services/device_info_service_test.dart.
...
class _FakeIosUtsname_7 extends _i1.SmartFake implements _i3.IosUtsname {
  _FakeIosUtsname_7(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockMacOsDeviceInfo extends _i1.Mock implements _i6.MacOsDeviceInfo {
  ...
  int get majorVersion =>
      (super.noSuchMethod(Invocation.getter(#majorVersion), returnValue: 0)
          as int);

  @override
  int get minorVersion =>
      (super.noSuchMethod(Invocation.getter(#minorVersion), returnValue: 0)
          as int);

  @override
  int get patchVersion =>
      (super.noSuchMethod(Invocation.getter(#patchVersion), returnValue: 0)
          as int);

  @override
  int get activeCPUs =>
      (super.noSuchMethod(Invocation.getter(#activeCPUs), returnValue: 0)
          as int);

  @override
  int get memorySize =>
      (super.noSuchMethod(Invocation.getter(#memorySize), returnValue: 0)
          as int);

  @override
  int get cpuFrequency =>
      (super.noSuchMethod(Invocation.getter(#cpuFrequency), returnValue: 0)
          as int);
